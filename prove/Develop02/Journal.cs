...
public class Journal
{
    ...
    public void LoadEntryPrompts()
    {
        ...
        if (this._json_init)
        {
            ...
            prompts.Add(prompt);
            prompt = new Prompt();
            prompt._value = "What did you do today to serve someone?";
            prompts.Add(prompt);
            prompt = new Prompt();
            prompt._value = "What did you ponder over in your scriptures today?";
            prompts.Add(prompt);
            prompt = new Prompt();
            prompt._value = "What Christ-like attribute did you emulate today and how?";
            prompts.Add(prompt);
            prompt = new Prompt();
            prompt._value = "How were you helped today and by who?";
            prompts.Add(prompt);
            prompt = new Prompt();
            prompt._value = "What outside event did you witness or ponder today?";
            prompts.Add(prompt);
            prompt = new Prompt();
